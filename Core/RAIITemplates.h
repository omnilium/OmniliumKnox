...
namespace knox::core {
		...
		public:
			...
			explicit AutoHandle(T hTarget) : Handle(hTarget) {
		...
		public:
			explicit AutoMutex(LPCWSTR lpMutexName) : _hMutex(CreateMutex(nullptr, FALSE, lpMutexName)) { }

			AutoMutex(AutoMutex& other) : _hMutex(other._hMutex.Handle) { }
